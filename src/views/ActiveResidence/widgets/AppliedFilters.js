...
const ChipsWrapper = ({ themeVariables, data, onTagCross }) => {
  return(
      ...
      <Col>
        ...
        >
          ...
          >
            ...
            {getResponsive({ default: "true", mobile: "false" }) === "true" && <ChipsWrapper onTagCross={onTagCross} data={data} themeVariables={themeVariables} />}
            <Col flex="none">
              <Button
                danger
                ghost
          ...
          {getResponsive({ default: "false", mobile: "true" }) === "true" && <Row style={{ paddingTop: themeVariables?.token?.paddingXS }}><ChipsWrapper onTagCross={onTagCross} data={data} themeVariables={themeVariables} /></Row>}
        </Card>
      </Col>
    </Row>
  );
