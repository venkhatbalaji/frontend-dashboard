...
import { getNewEmploymentRateStatistics } from "@/services/generalIndicatorsService";
...
function useNewEmploymentRate({ filters }) {
  ...
  const { isLoading, value, isEmpty, status, chartName } = useBaseHook({
    asyncFunction: getNewEmploymentRateStatistics,
    filters,
    dataPath: 'sectors',
  });
...
export default useNewEmploymentRate; 