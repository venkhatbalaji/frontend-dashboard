...
import { Empty, Text, Spin, Row, Col } from "re-usable-design-components";
...
import { checkIsPdfSectionEmpty, formatNumber } from "@/utils/helper";
...
// `country` is undefined for the pinned "All Nationalities" tab.
export default function ViolatorsStatisticsCountryPanel({ country, countryName, emiratesConfigValue, isCreatingPdf }) {
  ...
  return (
    <Page title={
      countryName
        ? `${translation[language]?.["Statistics of Violators in the UAE"] || "Statistics of Violators in the UAE"} - ${countryName}`
...
ViolatorsStatisticsCountryPanel.propTypes = {
