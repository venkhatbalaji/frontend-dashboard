...
import { Row, Col, Select, Button, PhosphorIcons } from "re-usable-design-components";
...
import RiskRegisterStatisticsCountryPanel from "./RiskRegisterStatisticsCountryPanel";
...
export default function RiskRegisterStatistics() {
  ...
  const handleExport = () => {
    ...
    const pdfName = activeCountryName
      ? `${baseTitle} - ${activeCountryName}.pdf`
      : `${baseTitle}.pdf`;
  ...
  return (
    <>
      ...
      <RiskRegisterStatisticsCountryPanel
        key={activeTab}
