...
import { getResidentsEmirates } from "@/services/activeGeneralService";
...
function VisaHoldersByEmiratesWrapper({ isPreview, isPreviewOpen, pageRef, filter: filters, emiratesConfigValue = [] }) {
  const intl = useIntl();
    ...
    <ResidensByEmirates
      ...
      title={
        <Row align="middle" gutter={4}>
          <Col flex="none">
            {intl?.formatMessage({ id: "Population By Emirate" })}
          </Col>
          <Col flex="none">
            <Tooltip
